...
public abstract class ComparableInputReader<T extends Comparable<T>, B extends ComparableInputReader<T, B>> extends InputReader<T, B> {
	...
	private String getStandardMinMaxErrorMessage() {
		if (minVal != null && maxVal != null)
			return Translate.tr("Expected") + " " + typeNameWithIndefiniteArticle() + " " +
				Translate.tr("value between") + " " + minVal + " " + Translate.tr("and") + " " + maxVal + ".";
		if (minVal != null)
			return Translate.tr("Expected") + " " + typeNameWithIndefiniteArticle() + " " +
				Translate.tr("value greater than or equal to") + " " + minVal + ".";
		if (maxVal != null)
			return Translate.tr("Expected") + " " + typeNameWithIndefiniteArticle() + " " +
				Translate.tr("value less than or equal to") + " " + maxVal + ".";
		return Translate.tr("Expected") + " " + typeNameWithIndefiniteArticle() + " " +
			Translate.tr("value") + ".";
	}
	...
	public void checkConfiguration() throws IllegalArgumentException {
		...
		if (minVal != null && maxVal != null && minVal.compareTo(maxVal) > 0)
			throw new IllegalArgumentException("minVal = " + minVal + ", maxVal = " + maxVal);
	}
