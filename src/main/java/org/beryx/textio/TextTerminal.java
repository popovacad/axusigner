...
public interface TextTerminal<T extends TextTerminal<T>> {
	 ...
	 */
	default <R> R applyWithPropertiesConfigurator(Consumer<TerminalProperties<?>> propertiesConfigurator, Function<TextTerminal<T>, R> action) {
	 ...
	 */
	default void executeWithPropertiesConfigurator(Consumer<TerminalProperties<?>> propertiesConfigurator, Consumer<TextTerminal<T>> action) {
		applyWithPropertiesConfigurator(propertiesConfigurator, t -> {
			action.accept(t);
			return null;
		});
	}
